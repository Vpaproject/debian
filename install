...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://insomnet4u.me/debian7fix/repo/screenfetch"
...
wget -O /home/vps/public_html/index.html "https://insomnet4u.me/debian7fix/repo/index.html"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://insomnet4u.me/debian7fix/repo/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://insomnet4u.me/debian7fix/repo/badvpn-udpgw64"
fi
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://insomnet4u.me/debian7fix/repo/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://insomnet4u.me/debian7fix/repo/mrtg-mem.sh"
...
curl "https://insomnet4u.me/debian7fix/repo/mrtg.conf" >> /etc/mrtg.cfg
...
# install vnstat gui
cd /home/vps/public_html/
wget https://insomnet4u.me/debian7fix/repo/vnstat_php_frontend-1.5.1.tar.gz
...
# install webmin
cd
wget "https://insomnet4u.me/debian7fix/repo/webmin_1.801_all.deb"
...
# download script
cd
wget https://insomnet4u.me/debian7fix/repo/install-premiumscript.sh -O - -o /dev/null|sh
...
wget https://insomnet4u.me/debian7fix/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
...
echo ""  | tee -a log-install.txt
echo "----------- Script Created By INSOMNET4U ------------"
